report 50615 "Certificado Retención Ganancia"
{
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("Invoice Withholding Buffer"; "Invoice Withholding Buffer")
            {
                ...
                column(Reg__General_Ret__RG__830_; 'Reg. General Ret. RG. 830')
                {
                }
                ...
                column("rstConfCont__Persona_habilitada_certificado_______rstConfCont__Carácter_persona_habilitada_"; strFirmante)
                {
                }
                column(Hoy; datHoy)
                {
                ...
                begin
                    ...
                    Clear(rstConfRet);
                    rstConfRet.SetRange("Tipo retenciones", "Tipo retencion"::Ganancias);
            ...
            dataitem("Factura RT Base Buffer2"; "Vendor Ledger Entry")
            {
                ...
                begin
                    ...
                    Clear(rstConfRet);
                    rstConfRet.SetRange("Tipo retenciones", "Invoice Withholding Buffer"."Tipo retencion"::Ganancias);
    ...
    begin
        ...
        if codSerie <> '' then
            "Invoice Withholding Buffer".SetRange("Serie retención", codSerie);
        rstConfCont.Get();
        if rstConfCont."Carácter persona habilitada" <> '' then
            strFirmante := rstConfCont."Persona habilitada certificado" + ', ' + rstConfCont."Carácter persona habilitada";
    end;
    ...
    begin
        Clear(rstIWB);
        rstIWB.SetRange("Tipo retencion", rstIWB."Tipo retencion"::Ganancias);
